...
const int contrast = 6200;// default contrast

// initial Time display is 12:59:45 Ti
int h=12;
int m=59;
int s=45;
int flag=1; //Ti
...
if(bl_TO==0)
{
analogWrite(bl,0);// comment out this line to turn Backlight OFF
bl_TO++;
}
